...
import { GroupToPromoteList, GroupToPromoteDelete } from '@/apis/advertisement'
...
export default {
  ...
  methods: {
    ...
    addAdvertise() {
      this.$router.push('/advertise/recommend-advertise-detail')
    },
    getAdList() {
      const { adName, pageSize, pageNum, type } = this
      GroupToPromoteList({ adName, pageSize, pageNum, type }).then(res => {
