...
import { NewProductList, NewProductDelete } from '@/apis/advertisement'
...
export default {
  ...
  methods: {
    ...
    addAdvertise() {
      this.$router.push('/advertise/product-advertise-detail')
    },
    getAdList() {
      const { adName, pageSize, pageNum, type } = this
      NewProductList({ adName, pageSize, pageNum, type }).then(res => {
