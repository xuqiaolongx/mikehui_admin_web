...
import { TodayGroupList, TodayGroupDelete } from '@/apis/advertisement'
...
export default {
  ...
  methods: {
    ...
    addAdvertise() {
      this.$router.push('/advertise/today-advertise-detail')
    },
    getAdList() {
      const { adName, pageSize, pageNum, type } = this
      TodayGroupList({ adName, pageSize, pageNum, type }).then(res => {
