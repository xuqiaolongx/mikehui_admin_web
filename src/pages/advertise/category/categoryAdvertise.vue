...
import { ClassifiedList, ClassifiedDelete } from '@/apis/advertisement'
...
export default {
  ...
  methods: {
    ...
    addAdvertise() {
      this.$router.push('/advertise/category-advertise-detail')
    },
    getAdList() {
      const { adName, pageSize, pageNum, type } = this
      ClassifiedList({ adName, pageSize, pageNum, type }).then(res => {
