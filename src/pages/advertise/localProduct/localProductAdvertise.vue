...
import { LocalSpecialityList, LocalSpecialityDelete } from '@/apis/advertisement'
...
export default {
  ...
  methods: {
    ...
    addAdvertise() {
      this.$router.push('/advertise/localProduct-advertise-detail')
    },
    getAdList() {
      const { adName, pageSize, pageNum, type } = this
      LocalSpecialityList({ adName, pageSize, pageNum, type }).then(res => {
