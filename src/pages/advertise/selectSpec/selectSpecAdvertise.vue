...
import { PickedSpecialityList, PickedSpecialityDelete } from '@/apis/advertisement'
...
export default {
  ...
  methods: {
    ...
    addAdvertise() {
      this.$router.push('/advertise/selectSpec-advertise-detail')
    },
    getAdList() {
      const { adName, pageSize, pageNum, type } = this
      PickedSpecialityList({ adName, pageSize, pageNum, type }).then(res => {
